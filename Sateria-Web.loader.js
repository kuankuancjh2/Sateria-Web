function createUnityInstance(t, n, l) {
    ...
    var s, u, f, h, b, m, g, p, w = "", v = "", y = (document.addEventListener("webkitfullscreenchange", function (e) {
    ...
    function x(e, t) {
        if ("symbolsUrl" != e) {
            var n = c.downloadProgress[e], r = (n = n || (c.downloadProgress[e] = {
                    started: !1,
                    finished: !1,
                    lengthComputable: !1,
                    total: 0,
        ...
        o.isConnected = new Promise(function (t, n) {
            try {
                ...
                e.onupgradeneeded = function (e) {
                    var t;
                    (e = (e = e).target.result).objectStoreNames.contains(f.name) || e.createObjectStore(f.name), e.objectStoreNames.contains(u.name) || (t = e.createObjectStore(u.name, {keyPath: "url"}), ["version", "company", "product", "updated", "revalidated", "accessed"].forEach(function (e) {
                        t.createIndex(e, e)
                    }))
    ...
    c.SystemInfo = function () {
        ...
        for (var l = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_\\.]+)", "MacOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], d = 0; d < l.length; ++d) if (u = i(l[d][0], o, 1)) {
    ...
    }, c.UnityCache = (s = {name: "UnityCache", version: 3}, u = {
        name: "RequestStore",
        version: 1
    }, f = {
        name: "WebAssembly",
        ...
        var e, t, a = m.getInstance(), n = E("string" == typeof r ? r : r.url),
            i = {enabled: (e = n, (!(t = o) || !t.method || "GET" === t.method) && ((!t || -1 != ["must-revalidate", "immutable"].indexOf(t.control)) && !!e.match("^https?://")))};
            ...
            require: function (e) {
                var t, n = {
                    "inflate.js": function (e, t, n) {
                        "use strict";
                        var c = e("./zlib/inflate"), f = e("./utils/common"), h = e("./utils/strings"),
                            b = e("./zlib/constants"), r = e("./zlib/messages"), o = e("./zlib/zstream"),
                            a = e("./zlib/gzheader"), m = Object.prototype.toString;
                        ...
                        i.prototype.push = function (e, t) {
                            var n, r, o, a, i, s = this.strm, l = this.options.chunkSize, d = this.options.dictionary,
                                u = !1;
                        ...
                        var r = "undefined" != typeof Uint8Array && "undefined" != typeof Uint16Array && "undefined" != typeof Int32Array,
                            o = (n.assign = function (e) {
                                ...
                                arraySet: function (e, t, n, r, o) {
                                    if (t.subarray && e.subarray) e.set(t.subarray(n, n + r), o); else for (var a = 0; a < r; a++) e[o + a] = t[n + a]
                        ...
                        d[254] = d[254] = 1, n.string2buf = function (e) {
                            ...
                            for (var n, r, o = t || e.length, a = new Array(2 * o), i = 0, s = 0; s < o;) if ((n = e[s++]) < 128) a[i++] = n; else if (4 < (r = d[n])) a[i++] = 65533, s += r - 1; else {
                        ...
                        "use strict";
                        var L = e("../utils/common"), O = e("./adler32"), I = e("./crc32"), A = e("./inffast"),
                            P = e("./inftrees"), D = 0, N = -2, z = 1, r = 852, o = 592;
                        ...
                        n.inflateReset = s, n.inflateReset2 = l, n.inflateResetKeep = i, n.inflateInit = function (e) {
                            ...
                            e:for (; ;) switch (n.mode) {
                                case z:
                                    if (0 === n.wrap) n.mode = 13; else {
                                        for (; u < 16;) {
                                            if (0 === s) break e;
                                            s--, d += r[a++] << u, u += 8
                                        }
                                        if (2 & n.wrap && 35615 === d) B[n.check = 0] = 255 & d, B[1] = d >>> 8 & 255, n.check = I(n.check, B, 2, 0), u = d = 0, n.mode = 2; else if (n.flags = 0, n.head && (n.head.done = !1), !(1 & n.wrap) || (((255 & d) << 8) + (d >> 8)) % 31) e.msg = "incorrect header check", n.mode = 30; else if (8 != (15 & d)) e.msg = "unknown compression method", n.mode = 30; else {
                                            if (u -= 4, x = 8 + (15 & (d >>>= 4)), 0 === n.wbits) n.wbits = x; else if (x > n.wbits) {
                                ...
                                case 12:
                                    if (5 === t || 6 === t) break e;
                                case 13:
                                    if (n.last) d >>>= 7 & u, u -= 7 & u, n.mode = 27; else {
                                        for (; u < 3;) {
                                            if (0 === s) break e;
                                            s--, d += r[a++] << u, u += 8
                                        }
                                ...
                                case 18:
                                    ...
                                    if (n.lencode = n.lendyn, n.lenbits = 7, S = {bits: n.lenbits}, _ = P(0, n.lens, 0, 19, n.lencode, 0, n.work, S), n.lenbits = S.bits, _) {
                                ...
                                case 19:
                                    for (; n.have < n.nlen + n.ndist;) {
                                        ...
                                        if (w < 16) d >>>= g, u -= g, n.lens[n.have++] = w; else {
                                            if (16 === w) {
                                                for (E = g + 2; u < E;) {
                                                    if (0 === s) break e;
                                                    s--, d += r[a++] << u, u += 8
                                    ...
                                    if (n.distbits = 6, n.distcode = n.distdyn, S = {bits: n.distbits}, _ = P(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, S), n.distbits = S.bits, _) {
                        ...
                        t.exports = function (e, t) {
                            var n, r, o, a, i, s, l = e.state, d = e.next_in, u = e.input, c = d + (e.avail_in - 5),
                                f = e.next_out, h = e.output, b = f - (t - e.avail_out), m = f + (e.avail_out - 257),
                                g = l.dmax, p = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, x = l.bits,
                                _ = l.lencode, S = l.distcode, E = (1 << l.lenbits) - 1, C = (1 << l.distbits) - 1;
                            e:do {
                                for (x < 15 && (k += u[d++] << x, x += 8, k += u[d++] << x, x += 8), n = _[k & E]; ;) {
                                    if (k >>>= r = n >>> 24, x -= r, 0 == (r = n >>> 16 & 255)) h[f++] = 65535 & n; else {
                                        if (!(16 & r)) {
                                            if (0 == (64 & r)) {
                                                n = _[(65535 & n) + (k & (1 << r) - 1)];
                                                continue
                        ...
                        t.exports = function (e, t, n, r, o, a, i, s) {
                            ...
                            if (k < x && (x = k), 0 === k) o[a++] = 20971520, o[a++] = 20971520, s.bits = 1; else {
                                for (y = 1; y < k && 0 === R[y]; y++) ;
                ...
                var t = 10, n = "UnityWeb Compressed Content (gzip)";
    ...
    function downloadBinaryMerge(urlId) {
        let url = c[urlId]
        if (Array.isArray(url)) {
            return Promise.all(url.map(u => T(u, false))).then(function (arrays) {
                let totalSize = arrays.reduce((acc, el) => acc + el.length, 0)
                let arr = new Uint8Array(totalSize)
                var size = 0
                for (var i = 0; i < arrays.length; i++) {
                    arr.set(arrays[i], size);
                    size += arrays[i].length;
                }

                return decompress(arr, urlId);
            })
        } else {
            return T(url, true)
        }
    ...
    function T(n, allowDecompress) {
        x(n);
        var e = c.cacheControl(n), t = c.companyName && c.productName ? c.cachedFetch : c.fetchWithProgress,
            r = n, r = /file:\/\//.exec(r) ? "same-origin" : void 0;
        return t(n, {
            method: "GET",
            ...
            if (allowDecompress) {
                return decompress(e.parsedBody, n)
            } else {
                return e.parsedBody;
            }
        }).catch(function (e) {
    ...
    function decompress(compressed, url) {
        return new Promise(function (resolve, reject) {
            try {
                for (var contentEncoding in U) {
                    if (U[contentEncoding].hasUnityMarker(compressed)) {
                        if (url)
                        ...
                        var decompressor = U[contentEncoding];
    ...
    function R() {
        Promise.all([downloadBinaryMerge("frameworkUrl").then(function (e) {
        ...
        }), downloadBinaryMerge("codeUrl")]).then(function (e) {
            c.wasmBinary = e[1], e[0](c)
        });
        var e = downloadBinaryMerge("dataUrl");
